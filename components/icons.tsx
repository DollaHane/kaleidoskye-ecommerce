...
const iconsStyles = "size-full text-zinc-700"
...
export const Icons = {
  ...
  twitter: Twitter,
  facebook: () => (
    <Link href={siteConfig.socials.facebook.href} target="_blank">
      <Facebook className={`${iconsStyles}`} />
    </Link>
  ),
  instagram: () => (
    <Link href={siteConfig.socials.instagram.href} target="_blank">
      <Instagram className={`${iconsStyles}`} />
    </Link>
  ),
  whatsapp: () => (
    <Link href={siteConfig.socials.whatsapp.href} target="_blank">
      <FaWhatsapp className={`${iconsStyles}`} />
    </Link>
  ),
  tiktok: () => (
    <Link href={siteConfig.socials.tiktok.href} target="_blank">
      <FaTiktok className={`${iconsStyles}`} />
    </Link>
  ),
  email: () => (
    <Link href={siteConfig.socials.email.href} target="_blank">
      <AtSign className={`${iconsStyles}`} />
    </Link>
  ),
  basket: () => (
    <svg
